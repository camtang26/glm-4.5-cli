...
// GLM-4.5 CLI Note: Google OAuth is not used for GLM-4.5 authentication.
// These are placeholder values to maintain compatibility with the original codebase.
const OAUTH_CLIENT_ID =
  'PLACEHOLDER_CLIENT_ID_NOT_USED_FOR_GLM';

// OAuth Secret value used to initiate OAuth2Client class.
// GLM-4.5 CLI Note: Google OAuth is not used for GLM-4.5 authentication.
// These are placeholder values to maintain compatibility with the original codebase.
const OAUTH_CLIENT_SECRET = 'PLACEHOLDER_SECRET_NOT_USED_FOR_GLM';
